---
title: "Hardship Scores and Pharmacy Distribution"
format: html
---
...
# add legend title
leg = ax.get_legend()
leg.set_title('Relative Hardship Levels per Tract')
leg.set_loc('lower left')



plt.tight_layout()
ax.set_title('Hardship Index Score\n Overlaid by Pharmacies\nChicago 2010 Census Tracts')
ax.axis('off')
ax.set_axis_off()

plt.savefig('hardship_pharm.png', bbox_inches='tight')
